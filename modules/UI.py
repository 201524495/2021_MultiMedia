...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.plainTextEdit_3.setGeometry(QtCore.QRect(20, 250, 521, 91))
        ...
        self.exit_pushButton.setGeometry(QtCore.QRect(310, 30, 75, 23))
        self.exit_pushButton.setObjectName("exit_pushButton")
        self.stop_pushButton = QtWidgets.QPushButton(Form)
        self.stop_pushButton.setGeometry(QtCore.QRect(410, 30, 76, 23))
    ...
    def retranslateUi(self, Form):
        ...
        self.addVideo_pushButton.setText(_translate("Form", "Add Video"))
